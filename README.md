## Description
Consider to review commits history and changes, to see how static imports were code split and replaced with the dynamic ones - essentiually, from "starting point" -> "demo feature dynamic loading scenarios" commit.
